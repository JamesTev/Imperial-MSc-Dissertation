...
\EndFor
\caption{Simultaneous iteration}\label{alg:simultaneous-iteration}
\end{algorithmic}
\end{algorithm}
...
The MicroPython implementation of the generalised eigenvalue in Algorithm \ref{algo:gen-eig-algo} can be found in Listing \ref{app-listing:gen-eig-prob-mpy} in Appendix \ref{app-listing:gen-eig-prob-mpy}.
