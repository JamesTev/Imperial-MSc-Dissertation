...
\begin{algorithm}
$\Phi_{B}, \Lambda_{B} \leftarrow B \Phi_{B}=\Phi_{B} \Lambda_{B}$\\
$\Phi_{B} \leftarrow \breve{\Phi}_{B}=\Phi_{B} \Lambda_{B}^{-1 / 2} \approx \Phi_{B}\left(\Lambda_{B}^{1 / 2}+\varepsilon I\right)^{-1}$\\
$\breve{A} \leftarrow \breve{A}=\breve{\Phi}_{B}^{\top} A \breve{\Phi}_{B}$\\
$\Phi_{A}, \Lambda_{A} \leftarrow \breve{A} \Phi_{A}=\Phi_{A} \Lambda_{A}$\\
$\Lambda \leftarrow \Lambda=\Lambda_{A}$\\
$\Phi \leftarrow \Phi=\breve{\Phi}_{B} \Phi_{A}$\\
$\text { return } \Phi, \, \Lambda$
